        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "Ann@email.com", "Ann", "Smith" },
                    { 3, "Jack@email.com", "Jack", "Taylor" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "lorem Ipsum ", "John", "Typ" },
                    { 2, "lorem Ipsum th", "Ann", "Typ" },
                    { 3, "lorem Ipsum lor", "Jack", "Typ" }
                });

            migrationBuilder.InsertData(
                table: "Patients",
                columns: new[] { "Id", "Birthday", "FirstName", "LastName" },
                values: new object[] { 1, new DateTime(2024, 6, 13, 19, 26, 45, 8, DateTimeKind.Local).AddTicks(3710), "Juri", "Gagrin" });
